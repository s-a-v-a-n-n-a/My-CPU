#ifndef CONSTANTS_DEFINITION
#define CONSTANTS_DEFINITION
...
const char ASSEMBLING_FILE_NAME[] = "asm.xax";
...
const int ADDRSS        = 6;
const int ADDRSS_RAX    = 7;
const int ADDRSS_RBX    = 8;
const int ADDRSS_RCX    = 9;
const int ADDRSS_RDX    = 10;
const int NOTHING       = 11;
